...
git_folder_location='C:\Users\Flo7u\workspace\'   #replace with the local root folder location where you want to create the project folder
project_name=ff-mlops   #replace with your project name
github_org_name=ms   #replace with your github org name
